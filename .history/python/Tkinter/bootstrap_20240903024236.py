...
def ADD():
    def clear(cond):
        if cond == 0:
            if len(color_var.get())<=6 and name_var.get() != "" and ((email_var.get() != "" and password_var.get() !="") and catagory_var.get() != 1 )and color_var.get() != "" and (Combo_Box.get() != "" and catagory_var.get() != 0 ):

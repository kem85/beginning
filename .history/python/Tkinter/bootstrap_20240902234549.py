...
def ADD():
    ...
    if not addwindow.get() and not editwindow.get():
        ...
        Catagory = tb.Checkbutton(addacc,width=15,text="Catagory",onvalue=1,offvalue=0,style='Custom.TCheckbutton',variable=catagory_var,command=lambda:((Color_Label.))).grid(column=1,row=4,pady=10,padx=10)

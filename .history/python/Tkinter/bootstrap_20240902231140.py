...
def ADD():
    ...
    if not addwindow.get() and not editwindow.get():
        ...
        Name_Entry = tb.Entry(addacc,width=15,variable=name_var,font=deffont).grid(column=1,row=0,pady=10,padx=10)
        Email_Entry = tb.Entry(addacc,width=15,font=deffont,variable=email_var).grid(column=1,row=1,pady=10,padx=10)
        Password_Entry = tb.Entry(addacc,width=15,font=deffont,variable=password_var).grid(column=1,row=2,pady=10,padx=10)
        Color_Entry = tb.Entry(addacc,width=15,font=deffont,variable=color_var).grid(column=1,row=3,pady=10,padx=10)
        style = tb.Style()

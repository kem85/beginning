...
style = tb.Style()
style.theme_use = "vapor"  # Choose a theme (e.g., clam, default, alt)
# Create a custom style using the 'configure' method
style.configure("RoundButton.TButton", background="blue", foreground="white", padding=10, width=20, height=20)
style.map("RoundButton.TButton", background=[("active", "darkblue")])
buttonn = tb.Button(root, text='Add',takefocus=False,width=10,style="RoundButton.TButton")

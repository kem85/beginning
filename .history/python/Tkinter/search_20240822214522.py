...
second_frame = Frame(my_canvas, bg="lightgrey", width=300, height=50*40)  # Ensure it's large enough
...
for i in range(50):
    ...
    button.place(x=100, y=i *40,anchor=tb.CENTER)  # Adjust the `y` coordinate for vertical placement

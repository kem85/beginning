...
def ADD():
    ...
    if not addwindow.get() and not editwindow.get():
        ...
        Name_Label = tb.Label(addacc, text='Name:',style=PRIMARY)Name_Label.grid(column=0,row=0)
        Password_Label = tb.Label(addacc, text='Password:',style=PRIMARY)Password_Label.grid(column=0,row=1)

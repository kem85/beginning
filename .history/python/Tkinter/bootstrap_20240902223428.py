...
def ADD():
    ...
    if not addwindow.get() and not editwindow.get():
        ...
        Password_Label = tb.Label(addacc, text='Password:',style=PRIMARY,font=deffont,foreground="#FF69B4").grid(column=0,row=1)
...
second_frame = Frame(my_canvas, width=300, height=50*35) #50*45, 45 is y for each button and 50 is number of button

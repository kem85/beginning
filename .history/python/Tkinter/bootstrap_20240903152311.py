    ...
    def clear(cond):
        if cond == 0:
            if ((len(color_var.get()) == 6) or color_var.get() == "") and name_var.get() != "" and ((email_var.get() != "" and password_var.get() !="" and Combo_Box.get() != "") or catagory_var.get()):
                ...
                if readbase("countc")+readbase("countb") != 0:
                    id_var.set(f"{readbase("countc")+readbase("countb")+1}")
                else:
                    id_var.set("1")
                database(name_var.get(),email_var.get(),password_var.get(),color_var.get() or "6e40c0",Combo_Box.get() or "false",id)
            else:

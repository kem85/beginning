...
def ADD():
    ...
    if not addwindow.get() and not editwindow.get():
        ...
        Password_Label = tb.Label(addacc, text='Password:',style=PRIMARY,font=deffont,foreground="#C0C0C0").grid(column=0,row=1)
        Color_Label = tb.Label(addacc, text='Color:',style=PRIMARY,font=deffont,foreground="#C0C0C0").grid(column=0,row=2)
        Name_Entry = tb.Entry(addacc,width=20,font=deffont).grid(column=1,row=0,pady=10,padx=10)
        Email_Label = tb.Label(addacc, text='Email:',style=PRIMARY,font=deffont,foreground="#C0C0C0").grid(column=0,row=2)
        Email_Entry = tb.Entry(addacc,width=20,font=deffont).grid(column=1,row=0,pady=10,padx=10)
        Password_Entry = tb.Entry(addacc,width=20,font=deffont).grid(column=1,row=1,pady=10,padx=10)
        Color_Entry = tb.Entry(addacc,width=20,font=deffont).grid(column=1,row=2,pady=10,padx=10)

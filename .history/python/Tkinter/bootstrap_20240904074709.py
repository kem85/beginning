...
def update_scrollregion(): #update 4 scrolling
    min_height = 330  # Adjust this value as needed
...
second_frame = Frame(my_canvas, width=340, height=5*35) #50*45, 45 is y for each button and 50 is number of button
my_canvas.create_window((0, 0), window=second_frame, anchor="nw")
#####################################################################
# windowcreate('catagory')
for i in range(5): #45 buttons
    button = tb.Button(second_frame, text=f'Button {i}',takefocus=False,width=13,style='Custom.TButton')
    if i % 2 == 0:
        button.place(x=10, y=i*35)
    else:

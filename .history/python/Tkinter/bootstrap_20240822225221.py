...
def openNewWindow(dooler):
    ...
    if not windowIsOpen:
        ...
        newWindow.protocol("WM_DELETE_WINDOW", command = lambda:openNewWindow(False))
    else:
...
add = tb.Button(root, text='Add',takefocus=False,width=10,style=PRIMARY,command=lambda:openNewWindow(windowIsOpen))

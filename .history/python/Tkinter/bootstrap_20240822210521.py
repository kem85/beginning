...
second_frame.grid_columnconfigure(0, weight=1)  # Center horizontally
second_frame.grid_rowconfigure(0, weight=1)  
my_canvas.create_window((0,0),window=second_frame,anchor="nw")
button2 = tb.Button(second_frame).grid(column=1,row=1)

for i in range(50):
    button = tb.Button(second_frame,text=f'Pablo {i}',takefocus=False,width=15,style=PRIMARY).grid(pady=10,padx=10,column=5,row=i)

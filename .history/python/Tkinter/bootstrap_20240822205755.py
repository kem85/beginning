...
for i in range(50):
    button = tb.Button(second_frame,text=f'Pablo {i*56*2}',takefocus=False,width=15,style=PRIMARY).grid(pady=10,padx=10,column=5,row=i)
search = tb.Entry(my_canvas, textvariable=text_var,width="30")

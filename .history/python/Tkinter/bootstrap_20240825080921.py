...
second_frame = Frame(my_canvas, width=600, height=50*45) #50*45, 45 is y for each button and 50 is number of button
...
edit= tb.Button(root, text='Edit',takefocus=False,width=10,style=PRIMARY,command=lambda:ADD())
add.pack(side='left', anchor='e')
edit.pack(side='right', anchor='w')

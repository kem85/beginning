...
def ADD():
    ...
    if not addwindow.get() and not editwindow.get():
        ...
        style = tb.Style()
        style.configure('Custom.TCheckbutton', font=('Helvetica', 18))
        Catagory = tb.Checkbutton(addacc,width=20,text="Catagory",onvalue=1,offvalue=0,style='Custom.TCheckbutton').grid(column=0,row=4)

...
def database():
   ...
   cursor.execute('INSERT INTO Student (ID) VALUES(?)',(name1,))
   cursor.execute('INSERT INTO Student (GG) VALUES(?)',(name1,))
   cursor.execute('INSERT INTO Student (BB) VALUES(?)',(name1,))
   conn.commit()

...
def subsub():
    global relx, rely
    rely += 1
    button1 = tb.Button(second_frame,text="great", style="PRIMARY",takefocus=False).grid(row=rely,column=1,pady=10,padx=10)
...
my_canvas.create_window((0,5),window=second_frame,anchor="nw")
button = tb.Button(second_frame, text="what is love", style="PRIMARY", command=subsub, takefocus=False).grid(row=1,column=1)

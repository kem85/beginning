...
def update_scrollregion():
    ...
    # Dynamically adjust the scroll region height based on content
    my_canvas.configure(scrollregion=(bbox[0], bbox[1], bbox[2], bbox[3]))
...
# Generate buttons to test scrolling
for i in range(2):  # Test with fewer buttons, e.g., 10

...
def subsub():
    global relx, rely
    rely += 1
    button1 = tb.Button(second_frame,text="great", style="PRIMARY",takefocus=False).grid(row=rely,column=1)
...
button = tb.Button(second_frame, text="what is love", style="PRIMARY", command=subsub, takefocus=False).grid(row=rely,column=1)
